export default {
    ...
    playerTpToDeath: 'Вы перемещены к точке смерти',
    playerTpToSpawn: 'Вы перемещены на спавн',
    typePlayerNameForTp: 'Введите имя человека, к которому хотите совершить телепортацию',
    playerNotFound: 'Игрок не найден (возможно он просто не в сети)',
    tpRequestSendFromPlayer: 'Запрос на телепортацию отправлен:',
    tpRequestSendToPlayer: 'У вас заявка на телепорт. Для подтверждения напишите /tpa',
    tpToSelf: 'Нельзя телепортироваться к себе',
    tpRequestAlreadySend: 'Запрос на телепортацию уже отправлен',
